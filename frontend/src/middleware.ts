...
const publicRoutes = ["/login", "/signup", "/forgot-password", "/reset-password", "/", "/api/auth/signup", "/api/auth/login", "/api/auth/verify", "/api/auth/send-otp", "/api/auth/signup-phone", "/api/auth/send-login-otp", "/api/auth/login-phone", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/health"];
